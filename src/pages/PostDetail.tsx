...
const placeholderImages = [
  ...
  'https://images.unsplash.com/photo-1557992260-ec58e38d363c?w=1200&h=600&fit=crop',
  'https://images.unsplash.com/photo-1586339949916-3e9457bef6d3?w=1200&h=600&fit=crop',
];

const fallbackImage = 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=1200&h=600&fit=crop';
      ...
      <main className="container py-8 md:py-12">
        <article className="max-w-4xl mx-auto">
          ...
          >
            <Link
              to="/"
              className={`inline-flex items-center gap-2 btn-ghost mb-8 ${isRTL ? 'flex-row-reverse' : ''}`}
            >
              {isRTL ? <ArrowRight className="w-4 h-4" /> : <ArrowLeft className="w-4 h-4" />}
              {t('backToNews')}
            </Link>
          ...
          >
            ...
            <div className={`absolute bottom-0 left-0 right-0 p-6 md:p-10 ${isRTL ? 'text-right' : 'text-left'}`}>
              <span className="inline-block px-3 py-1 mb-4 text-xs font-medium uppercase tracking-wider rounded-full bg-accent text-accent-foreground">
                {t('news')}
              </span>
            </div>
          </motion.div>
          ...
          <motion.h1
            ...
            className="headline-xl mb-8 capitalize"
          >
            {news.title}
          </motion.h1>
          ...
          <motion.div
            ...
            className="glass-card rounded-2xl p-6 mb-10 border-border"
          >
            ...
            <div className={`mt-6 pt-6 border-t border-divider flex items-start gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
              ...
              <div>
                ...
                <p className="body-md italic text-muted-foreground">
                  "{news.author.company.catchPhrase}"
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            {/* Extended content for visual purposes */}
